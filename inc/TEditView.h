...
/// EditVIew 样式(1:编辑 2:数据展示)
/// 是否允许编辑   editEnabled
/// 是否允许换行   linesEnabled
/// 是否有边框     boardEnabled
/// 是否显示编辑提示   placeholderEnabled
/// 是否整行显示备注   fullRemarkEnabled


/// 顶部空白长度              topSpace
/// 左侧空白长度(sectionView) leftSpace
/// 左边内容宽度              leftWidth
...
//    /// 是否允许编辑 默认:YES
//    BOOL editEnabled;
//    /// 是否显示编辑提示 默认:YES(可编辑状态)
//    BOOL placeholderEnabled;
//    /// 是否整行显示备注 默认:YES(可编辑状态)
//    BOOL fullMarkEnabled;
//    /// 是否有边框 默认:YES
//    BOOL borderEnabled;
//    /// 边框图片 默认:[UIImage getImage:@"edit_round_bg.png"]
//    UIImage* borderBgImg;
//    /// 边框左右边距 默认:10
//    float borderLeft;
//    
//    /// 分组top 默认:10
//    float contentTop;
//    /// 分割线 默认:[UIImage getImage:@"edit_line_1.png"]
//    UIImage* contentLineImg;
//    
//    
//    /// 分组 左边宽
//    float contentLeftWidth;
//    /// 分组
//    float contentLeftWidth;
////    float contentLeftWidth;
//    
